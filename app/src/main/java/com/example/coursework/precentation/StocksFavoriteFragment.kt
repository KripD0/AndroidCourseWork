...
import com.example.coursework.databinding.FragmentStocksFavoriteBinding
import com.example.coursework.domain.utils.Rezult
import kotlinx.coroutines.flow.collect
import kotlinx.coroutines.flow.onEach
import kotlinx.coroutines.launch
import org.koin.androidx.viewmodel.ext.android.viewModel
class StocksFavoriteFragment : Fragment() {
    private val viewModel by viewModel<StocksFavoriteViewModel>()
    private lateinit var viewAdapter: StocksAdapter
    private lateinit var binding: FragmentStocksFavoriteBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = FragmentStocksFavoriteBinding.inflate(inflater)
